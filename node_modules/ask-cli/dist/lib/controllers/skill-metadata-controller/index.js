...
const { IMPORT_STATUS_AC_BUILD_SUCCESS_EVENT, IMPORT_STATUS_AC_BUILD_FAILED_EVENT, IMPORT_STATUS_BUILDING_AC_FULL_EVENT, IMPORT_STATUS_BUILDING_AC_LIGHT_EVENT, IMPORT_STATUS_IM_BUILD_SUCCESS_EVENT, IMPORT_STATUS_IM_BUILD_FAILED_EVENT, } = require("../../view/import-status/import-status-view-events");
...
module.exports = class SkillMetadataController {
 ...
 please make sure the skill metadata deployment has succeeded with result of a valid skillId.`);
    ...
    _pollImportStatus(importId, callback) {
        const retryConfig = this.getIsAcSkill() === true
            ? {
                ...
                if ((buildStatusLocalCacheEntry === null || buildStatusLocalCacheEntry === void 0 ? void 0 : buildStatusLocalCacheEntry.hasBuildStarted()) && (smapiBuildDetailStep === null || smapiBuildDetailStep === void 0 ? void 0 : smapiBuildDetailStep.isACBuildType)) {
                    ...
                    if (localBuildDetailStep.buildStatus !== buildStatus) {
                        ...
                        if (buildStatus === CONSTANTS.SKILL.SKILL_STATUS.SUCCEEDED) {
                            ...
                            this.getImportStatusPollView().publishEvent(lastUpdatedLocale, IMPORT_STATUS_AC_BUILD_FAILED_EVENT, `${this.getBuildNameFromType(buildType)} failed for locale: ${lastUpdatedLocale}.`);
                        }
                    }
