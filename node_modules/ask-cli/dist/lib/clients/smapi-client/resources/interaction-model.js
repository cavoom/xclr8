...
module.exports = (smapiHandle) => {
    function getInteractionModel(skillId, stage, locale, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.GET_INTERACTION_MODEL, CONSTANTS.HTTP_REQUEST.VERB.GET, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    function setInteractionModel(skillId, stage, locale, modelSchema, eTag, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.SET_INTERACTION_MODEL, CONSTANTS.HTTP_REQUEST.VERB.PUT, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, eTag ? { "If-Match": eTag } : {}, payload, callback);
    }
    function headInteractionModel(skillId, stage, locale, callback) {
        const url = `skills/${skillId}/stages/${stage}/interactionModel/locales/${locale}`;
        smapiHandle(CONSTANTS.SMAPI.API_NAME.HEAD_INTERACTION_MODEL, CONSTANTS.HTTP_REQUEST.VERB.HEAD, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    /**
    ...
    function listInteractionModelVersions(skillId, stage, locale, queryParams, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.LIST_INTERACTION_MODEL_VERSIONS, CONSTANTS.HTTP_REQUEST.VERB.GET, CONSTANTS.SMAPI.VERSION.V1, url, queryObject, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    return {
        getInteractionModel,
        setInteractionModel,
