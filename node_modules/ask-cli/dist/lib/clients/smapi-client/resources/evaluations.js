...
module.exports = (smapiHandle) => {
    ...
    function callProfileNlu(skillId, stage, locale, utterance, multiTurnToken, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.NLU_PROFILE, CONSTANTS.HTTP_REQUEST.VERB.POST, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, payload, callback);
    }
    return {
        callProfileNlu,
    };
