...
module.exports = (smapiHandle) => {
    ...
    function createBetaTest(skillId, feedbackEmail, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.CREATE_BETA_TEST, CONSTANTS.HTTP_REQUEST.VERB.POST, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, payload, callback);
    }
    /**
    ...
    function updateBetaTest(skillId, feedbackEmail, callback) {
        const url = `skills/${skillId}/betaTest`;
        const payload = stringUtils.isNonBlankString(feedbackEmail) ? { feedbackEmail } : EMPTY_PAYLOAD;
        smapiHandle(CONSTANTS.SMAPI.API_NAME.UPDATE_BETA_TEST, CONSTANTS.HTTP_REQUEST.VERB.PUT, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, payload, callback);
    }
    /**
    ...
    function getBetaTest(skillId, callback) {
        const url = `skills/${skillId}/betaTest`;
        smapiHandle(CONSTANTS.SMAPI.API_NAME.GET_BETA_TEST, CONSTANTS.HTTP_REQUEST.VERB.GET, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, EMPTY_PAYLOAD, callback);
    }
    /**
    ...
    function startBetaTest(skillId, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.START_BETA_TEST, CONSTANTS.HTTP_REQUEST.VERB.POST, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, EMPTY_PAYLOAD, callback);
    }
    /**
    ...
    function endBetaTest(skillId, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.END_BETA_TEST, CONSTANTS.HTTP_REQUEST.VERB.POST, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, EMPTY_PAYLOAD, callback);
    }
    /**
    ...
    function listBetaTesters(skillId, queryParams, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.LIST_BETA_TESTERS, CONSTANTS.HTTP_REQUEST.VERB.GET, CONSTANTS.SMAPI.VERSION.V1, url, queryObject, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    /**
