...
module.exports = (smapiHandle) => {
    ...
    function getIntentRequestsHistory(skillId, queryParams, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.INTENT_REQUEST_HISTORY, CONSTANTS.HTTP_REQUEST.VERB.GET, CONSTANTS.SMAPI.VERSION.V1, url, queryObject, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    return {
