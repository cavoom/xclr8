...
module.exports = (smapiHandle) => {
    ...
    function getTask(skillId, taskName, taskVersion, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.GET_TASK, CONSTANTS.HTTP_REQUEST.VERB.GET, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    /**
    ...
    function searchTask(skillId, keywords, providerSkillId, queryParams, callback) {
        ...
        const url = "tasks/";
        smapiHandle(CONSTANTS.SMAPI.API_NAME.SEARCH_TASK, CONSTANTS.HTTP_REQUEST.VERB.GET, CONSTANTS.SMAPI.VERSION.V1, url, queryObject, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    return {
        getTask,
        searchTask,
