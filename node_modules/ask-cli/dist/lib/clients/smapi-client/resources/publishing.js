...
module.exports = (smapiHandle) => {
    function submitSkill(skillId, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.SUBMIT, CONSTANTS.HTTP_REQUEST.VERB.POST, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    function withdrawSkill(skillId, withdrawReason, withdrawMessage, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.WITHDRAW, CONSTANTS.HTTP_REQUEST.VERB.POST, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, payload, callback);
    }
    /**
    ...
    function listCertifications(skillId, queryParams, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.LIST_CERTIFICATIONS, CONSTANTS.HTTP_REQUEST.VERB.GET, CONSTANTS.SMAPI.VERSION.V1, url, queryObject, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    /**
    ...
    function getCertification(skillId, certificationId, acceptLanguage, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.GET_CERTIFICATION, CONSTANTS.HTTP_REQUEST.VERB.GET, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, headers, NULL_PAYLOAD, callback);
    }
    return {
        submitSkill,
        withdrawSkill,
