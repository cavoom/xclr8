...
module.exports = (smapiHandle) => {
    function createIsp(vendorId, ispDefinition, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.CREATE_ISP, CONSTANTS.HTTP_REQUEST.VERB.POST, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, payload, callback);
    }
    function getIsp(ispId, stage, callback) {
        const url = `${ISP_URL_BASE}/${ispId}/stages/${stage}`;
        smapiHandle(CONSTANTS.SMAPI.API_NAME.GET_ISP, CONSTANTS.HTTP_REQUEST.VERB.GET, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    ...
    function updateIsp(ispId, stage, ispDefinition, eTag, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.UPDATE_ISP, CONSTANTS.HTTP_REQUEST.VERB.PUT, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, headers, payload, callback);
    }
    function associateIsp(ispId, skillId, callback) {
        const url = `${ISP_URL_BASE}/${ispId}/skills/${skillId}`;
        smapiHandle(CONSTANTS.SMAPI.API_NAME.ASSOCIATE_ISP, CONSTANTS.HTTP_REQUEST.VERB.PUT, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    function disassociateIsp(ispId, skillId, callback) {
        const url = `${ISP_URL_BASE}/${ispId}/skills/${skillId}`;
        smapiHandle(CONSTANTS.SMAPI.API_NAME.DISASSOCIATE_ISP, CONSTANTS.HTTP_REQUEST.VERB.DELETE, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    /**
    ...
    function listIspForVendor(vendorId, productIdList, stage, referenceName, status, type, isAssociatedWithSkill, queryParams, callback) {
        ...
        const url = `${ISP_URL_BASE}`;
        smapiHandle(CONSTANTS.SMAPI.API_NAME.LIST_ISP_FOR_VENDOR, CONSTANTS.HTTP_REQUEST.VERB.GET, CONSTANTS.SMAPI.VERSION.V1, url, queryObject, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    /**
    ...
    function listIspForSkill(skillId, stage, queryParams, callback) {
        ...
        smapiHandle(CONSTANTS.SMAPI.API_NAME.LIST_SKILLS_FOR_ISP, CONSTANTS.HTTP_REQUEST.VERB.GET, CONSTANTS.SMAPI.VERSION.V1, url, queryObject, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    /**
    ...
    function deleteIsp(ispId, stage, eTag, callback) {
        const url = `${ISP_URL_BASE}/${ispId}/stages/${stage}`;
        const headers = eTag ? { "If-Match": eTag } : {};
        smapiHandle(CONSTANTS.SMAPI.API_NAME.DELETE_ISP, CONSTANTS.HTTP_REQUEST.VERB.DELETE, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, headers, NULL_PAYLOAD, callback);
    }
    function resetIspEntitlement(ispId, stage, callback) {
        const url = `${ISP_URL_BASE}/${ispId}/stages/${stage}/entitlement`;
        smapiHandle(CONSTANTS.SMAPI.API_NAME.RESET_ISP_ENTITLEMENT, CONSTANTS.HTTP_REQUEST.VERB.DELETE, CONSTANTS.SMAPI.VERSION.V1, url, EMPTY_QUERY_PARAMS, EMPTY_HEADERS, NULL_PAYLOAD, callback);
    }
    return {
        createIsp,
        getIsp,
