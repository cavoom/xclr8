...
function retry(retryConfig, retryCall, shouldRetryCondition, callback) {
    ...
    if (!retryConfig.maxRetry) {
        return callback("[Error]: Invalid retry configuration: maxRetry. " + "MaxRetry is a required configuration and its value needs to be greater than 0");
    }
